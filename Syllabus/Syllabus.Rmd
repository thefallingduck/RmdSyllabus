---
title: 'GY306(W): Sedimentology and Stratigraphy'
date: "Fall 2025"
output:
  pdf_document:
    keep_tex: yes
...
October 31st - Last day to drop or withdraw. See the [Academic Calendar](https://www.southalabama.edu/academiccalendar/) for more information.\
...
kable(MeetingDays[,c("Date", "Lecture", "Lab", "Reading")],
      format = "latex",
      align = c("l", "l", "l", "l"),
      linesep = "",
      booktabs = TRUE) %>%
