...
- name: Dr. Benjamin J. Linzmeier
  ...
  officehours: 11 AM – 12 PM Mo, W, F \newline 2 PM – 5 PM Mo
...
SemesterStart <- as.Date("2025/1/13")

#Semester end date for classes as YYYY/M/D.
SemesterEnd <- as.Date("2025/5/02")
...
April 11th - Last day to drop or withdraw\
May 5th - Final exam from 1-3 PM
...
Short ~12 minute presentation with discussion of research plan in class.
