...
- name: Dr. Benjamin J. Linzmeier
  ...
  prefered_contact: Canvas messages
  officehours: 10 AM – 12 PM and 2 - 4 PM Mo \newline 10 AM - 12 PM We or by appointment. \newline
...
SemesterStart <- as.Date("2026/1/12")

#Semester end date for classes as YYYY/M/D.
SemesterEnd <- as.Date("2026/5/02")
...
SpringBreak <-
  seq.Date(
    from = as.Date("2026/03/09"),
    to = as.Date("2026/03/15"),
    by = "day"
  )
#Mardi gras break start and stop date.
MardiGrasBreak <-
  seq.Date(
    from = as.Date("2026/02/16"),
    to = as.Date("2026/02/17"),
    by = "day"
  )
...
Holidays <-
  ...
  )), SpringBreak, FallBreak, DayBeforeThnks, MardiGrasBreak)
...
Lecture_Topic <- c("Introduction and overview",
                   ...
                   "The Climate System",
                   "The Climate System",
                   "Coasts, Glaciers, and Changing sea level",
                   "Coasts, Glaciers, and Changing sea level",
                   "Coasts, Glaciers, and Changing sea level"
                   )
...
# Important Dates
January 19th - Last day to opt-out of [JagPack](https://www.southalabama.edu/programs/jagpack/)
January 19th - Last day to drop without WD\
...
### Missing work
Everyone will have their lowest two discussion posts, readings, and quizzes dropped. Six gots/nots will be dropped. This means that you have two weeks of built-in flexibility for life events that come up (e.g. illness, unexpected travel).
...
### Extra credit
Extra credit may be made available throughout the semester. These may fill in for readings, discussions, gots/nots, or quizzes that you miss or do poorly on.
...
<!-- The sections of code below that include "child=..." are drawing from separate .md documents. These allow for updating text in a single spot for use in multiple syllabus documents. -->
