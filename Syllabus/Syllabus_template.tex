...
\hypersetup{breaklinks=true,
            ...
            pdflang={$if(lang)$$lang$$else$en-US$endif$}, % Required by UA checkers
...
$for(instructor)$
  ...
  Preferred contact: $instructor.prefered_contact$\\
  Office Hours: $instructor.officehours$\\
  Office: $instructor.office$\\
  Correspondence policy: $instructor.correspondence_policy$\\
  $if(instructor)$
  \columnbreak
  $endif$
